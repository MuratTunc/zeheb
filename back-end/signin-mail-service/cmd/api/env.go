...
var (
	DBHost      = os.Getenv("SIGN_IN_POSTGRES_DB_HOST")
	DBUser      = os.Getenv("SIGN_IN_POSTGRES_DB_USER")
	DBPassword  = os.Getenv("SIGN_IN_POSTGRES_DB_PASSWORD")
	DBName      = os.Getenv("SIGN_IN_POSTGRES_DB_NAME")
	ServicePort = os.Getenv("SIGN_IN_SERVICE_PORT")
	ServiceName = os.Getenv("SIGN_IN_SERVICE_NAME")
)
